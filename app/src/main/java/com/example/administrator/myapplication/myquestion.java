...
public class myquestion extends yijiejue{
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case 0x002:
                    ...
                    Toast.makeText( myquestion.this, "加载完毕", Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wancheng.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                HTML_URL3 = "http://www.buqi5.cn:8080/web/index5_update.php?themeid="+themeid;
                Log.e("TAG", String.valueOf(themeid));
                setViews();
