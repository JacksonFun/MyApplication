...
public class myquestion_list extends denglu{
    private int  flag=0;
    ...
    private Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case 0x001:
                    Toast.makeText( myquestion_list.this, "error", Toast.LENGTH_SHORT).show();
                    break;
                case 0x002:
                    parseEasyJson(detail);
                    Toast.makeText( myquestion_list.this, "加载完毕", Toast.LENGTH_SHORT).show();
                    break;
    ...
    protected void onCreate(Bundle saveInstanceState){
        ...
        HTML_URL3 = "http://www.buqi5.cn:8080/web/index4_my.php?user_id="+user_id;
        setViews();
...
//                person.setAge(jsonObject.getString("qid"));
                MyAdapter_answer.add(new Data(R.mipmap.ic_icon_qitao, jsonObject.getString("theme"),jsonObject.getInt("id"), 1));
//                persons.add(person);
